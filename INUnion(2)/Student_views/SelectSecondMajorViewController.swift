//
//  SelectSecondMajorViewController.swift
//  INUnion(2)
//
...
class SelectSecondMajorViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    @IBOutlet weak var SearchBar: UISearchBar!
    @IBOutlet weak var tableView: UITableView!
    var isShowed: Bool = false
    var searchActive: Bool = false // 검색중일시 True
    ...
    let departments = ["없음", "건설환경공학부", "경영학부", "경제학과", "공연예술학과", "국어교육과", "국어국문학과",
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){// 학생 정보 클래스에 정보 전달
        if searchActive{
            PersonInfo.SecondMajor = filtered[indexPath.row]
            SecondMajorUserDefault.set(PersonInfo.SecondMajor, forKey: "SecondMajor")
        } else{
            PersonInfo.SecondMajor = departments[indexPath.row]
            SecondMajorUserDefault.set(PersonInfo.SecondMajor, forKey: "SecondMajor")
        }
